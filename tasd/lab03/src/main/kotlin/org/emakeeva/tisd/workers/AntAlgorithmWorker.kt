...
import org.emakeeva.tisd.models.Ant
...
class AntAlgorithmWorker {
    ...
    private var ro = 1.0 //  количество испарения феромона
    ...
    fun changeParams(alpha: Double, ro: Double, countIteration: Int) {
        this.alpha = alpha
        this.ro = ro
